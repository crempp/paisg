...
namespace AffinityUI
{
	...
	public class Area : Composite
	{
		...
		{
			throw new NotSupportedException("EditorGUI not supported by the Box control.");
		}
		...
		{
			throw new NotSupportedException("EditorGUILayout is not supported by the Area control.");
		}
