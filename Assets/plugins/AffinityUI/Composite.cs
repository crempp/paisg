...
namespace AffinityUI
{
	...
	public abstract class Composite : Control, IEnumerable<Control>
	{
		...
		/// <see cref="OnBeginLayout_EditorGUILayout"/>, <see cref="OnBeginLayout_GUI"/> or
		/// <see cref="OnBeginLayout_EditorGUI"/>.
		/// </summary>
		/// <remarks>
		/// Override this method if you need complete control over GUI layout. Otherwise override
		/// <see cref="OnBeginLayout_GUILayout"/> and/or <see cref="OnBeginLayout_EditorGUILayout"/>.
		/// </remarks>
		protected virtual void OnBeginLayout()
		{
			...
			else if (TargetType == typeof(EditorGUILayout))
			{
				OnBeginLayout_EditorGUILayout();
			}
			else if (TargetType == typeof(GUI))
			{
				OnBeginLayout_GUI();
			}
			else if (TargetType == typeof(EditorGUI))
			{
				OnBeginLayout_EditorGUI();
			}
		}

		/// <summary>
		/// Called when layout end. Automatically calls <see cref="OnBeginLayout_GUILayout"/>,
		/// <see cref="OnBeginLayout_EditorGUILayout"/>, <see cref="OnBeginLayout_GUI"/> or
		/// <see cref="OnBeginLayout_EditorGUI"/>.
		/// </summary>
		/// <remarks>
		/// Override this method if you need complete control over GUI layout. Otherwise override
		/// <see cref="OnEndLayout_GUILayout"/> and/or <see cref="OnEndLayout_EditorGUILayout"/>.
		/// </remarks>
		...
		/// <summary>
		/// Called when layout begins using EditorGUI.
		/// </summary>
		protected virtual void OnBeginLayout_EditorGUI() { }

		/// <summary>
		/// Called when layout ends using EditorGUI.
		/// </summary>
		protected virtual void OnEndLayout_EditorGUI() { }
		...
		/// </summary>
		protected virtual void OnBeginLayout_EditorGUILayout() { }

		/// <summary>
		/// Called when layout ends when using EditorGUILayout.
		/// </summary>
		protected virtual void OnEndLayout_EditorGUILayout() { }
		...
		public static TComposite Create<TGuiTarget, TComposite>() where TComposite : Composite, new()
		{
			...
			if (result.TargetType != typeof(GUILayout) &&
				result.TargetType != typeof(EditorGUILayout) &&
				result.TargetType != typeof(EditorGUI) &&
				result.TargetType != typeof(GUI))
			{
				throw new ArgumentException("Generic argument must be type GUI, EditorGUI, GUILayout or EditorGUILayout", "TGuiTarget");
			}
			return result;
		}
