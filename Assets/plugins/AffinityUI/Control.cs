...
namespace AffinityUI
{
	...
	public abstract class Control
	{
		...
		/// <summary>
		/// Type of <see cref="EditorGUI"/>.
		/// </summary>
		protected static readonly Type EditorGUIType = typeof(EditorGUI);

		/// <summary>
		/// Type of <see cref="EditorGUILayout"/>.
		/// </summary>
		protected static readonly Type EditorGUILayoutType = typeof(EditorGUILayout);
		...
		/// This method automatically calls <see cref="Layout_GUI"/>, <see cref="Layout_EditorGUI"/>,
		/// <see cref="Layout_GUILayout"/> or <see cref="Layout_EditorGUILayout"/> depending on the
		/// GUI target.
		/// </remarks>
		public virtual void Layout()
		{
			...
			else if (TargetType == EditorGUIType)
			{
				Layout_EditorGUI();
			}
			else if (TargetType == EditorGUILayoutType)
			{
				Layout_EditorGUILayout();
			}
		}
		...
		/// </summary>
		protected virtual void Layout_EditorGUI() { }

		/// <summary>
		/// Called when layout is done using EditorGUILayout.
		/// </summary>
		protected virtual void Layout_EditorGUILayout() { }
